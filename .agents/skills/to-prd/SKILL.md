...
This skill takes the current conversation context and codebase understanding and produces a PRD. Do NOT post the user — just synthesize what you already know.
